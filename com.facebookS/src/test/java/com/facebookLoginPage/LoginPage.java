...
public class LoginPage {
	...
	public WebElement getUserName() {
		...
		driver.findElement(By.id("email")).sendKeys("mgsuarez8");
...
public WebElement getEmailAddress() {
	driver.findElement(By.name("reg_email__")).sendKeys("mgsuarez8@gmail");
	return null;
}
/*public WebElement getPassword("password").sendkeys
password
id="day"
id="month"
id='year"*/
